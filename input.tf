variable "standard_os" {
  default = {
    ...
    "WindowsServer2019SqlServer2019Web"        = "microsoftsqlserver,sql2019-ws2019,sqldev"
    "WindowsServer2019SqlServer2019Standard"   = "microsoftsqlserver,sql2019-ws2019,sqldev"
    "WindowsServer2019SqlServer2019Enterprise" = "microsoftsqlserver,sql2019-ws2019,sqldev"
